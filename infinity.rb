...
# Generates stories by harvesting content from Fanfiction.net and semi-randomly
...
# search page, e.g.
# https://www.fanfiction.net/book/Hunger-Games/

INDEX_URL = 'https://www.fanfiction.net/book/Hunger-Games/'

# Used to catch sentences which aren't part of the actual text.
...
# Store start time
startTime = Time.now
print "Generation started at: #{startTime}\n"
...
# Write a title. Steal a line of dialog so we have something interesting
...
print "processing complete in #{generationTime} seconds.\n"